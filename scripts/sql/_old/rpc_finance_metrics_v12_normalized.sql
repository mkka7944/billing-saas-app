-- RPC: get_finance_summary_metrics (V12 - NORMALIZED COMPARISON)
-- Purpose: Includes 'total_transactions' and Normalizes string comparisons to fix Sargodha/Bhalwal/Khushab gaps.
...
BEGIN
    ...
    SELECT json_build_object(
        ...
        'total_transactions', COALESCE(SUM(payment_count), 0)
    ) INTO v_grand_totals
    FROM filtered_bills;

    -- 2. Tehsil Stats (NORMALIZED)
